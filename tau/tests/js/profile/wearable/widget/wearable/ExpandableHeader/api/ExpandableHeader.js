...
test("API" , function () {
	...
	equal(typeof tau.widget.wearable.ExpandableHeader, 'function', 'Class tau.widget.wearable.ExpandableHeader exists');
	widget = new tau.widget.wearable.ExpandableHeader();
