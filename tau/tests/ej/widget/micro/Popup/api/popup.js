...
(function (window, document) {
    ...
    var page = null,
        ...
        popup1 = null,
        popup1Widget = null,
        PopupClass = ej.widget.micro.Popup,
        engine = ej.engine;
    ...
    testPopup('test prototype', function () {
        testPopupMethodApi(ej.widget.micro.Popup.prototype);
    });
    ...
    testPopup('test instance', function () {
        ...
        equal(definition.namespace, 'micro', 'definition.namespace exists and is proper type and value');
