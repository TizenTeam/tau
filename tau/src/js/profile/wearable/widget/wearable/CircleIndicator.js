		...
		function () {
			...
			var BaseWidget = ns.widget.BaseWidget,
				...
				CircleIndicator = function () {
					 ...
					 * @property {number} [options.textDigits = "0"] represet number with defined number of digits
			...
			function prepareArcIndicator(self, properties) {
				...
				//in order to to set proper start point 90deg needs to be added to strt
				//point
				...
				//set the begining for animation
				svgIndicator.style.transform = "rotate(" + startPointForAnimation + "deg)";

				//hiding indicator at the begining
