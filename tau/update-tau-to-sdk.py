...
jobs = {
	...
	"3_tizen_sdk_mobile_profile": Job(
		...
		sdkTizenMobile,
		[
			SrcDest("tau/demos/MobileWinset", "samples/web/Sample/Tizen/Web\ App/TizenWinset/project"),
			SrcDest("tau/dist/mobile", "samples/web/Sample/Tizen/Web\ App/TizenWinset/project/lib/tau/mobile"),
			SrcDest("tau/dist/mobile", "samples/web/Template/Tizen/Tizen\ Web\ UI\ Framework/Tizen_Web_UI_FW_MasterDetail/project/lib/tau/mobile"),
			SrcDest("tau/dist/mobile", "samples/web/Template/Tizen/Tizen\ Web\ UI\ Framework/Tizen_Web_UI_FW_MultiPage/project/lib/tau/mobile"),
			SrcDest("tau/dist/mobile", "samples/web/Template/Tizen/Tizen\ Web\ UI\ Framework/Tizen_Web_UI_FW_NavigationView/project/lib/tau/mobile"),
			SrcDest("tau/dist/mobile", "samples/web/Template/Tizen/Tizen\ Web\ UI\ Framework/Tizen_Web_UI_FW_SinglePage/project/lib/tau/mobile"),
		], ["cd web-ui-fw/tau", "grunt build"],
		[
			"samples/web/Sample/Tizen/Web\ App/AnalogWatch/project",
			"samples/web/Sample/Tizen/Web\ App/AudioFilter/project",
			"samples/web/Sample/Tizen/Web\ App/BluetoothChat/project",
			"samples/web/Sample/Tizen/Web\ App/CallLog/project",
			"samples/web/Sample/Tizen/Web\ App/Chatter/project",
			"samples/web/Sample/Tizen/Web\ App/Compass/project",
			"samples/web/Sample/Tizen/Web\ App/ContactsExchanger/project",
			"samples/web/Sample/Tizen/Web\ App/DeviceMotionCapture/project",
			"samples/web/Sample/Tizen/Web\ App/DynamicBox/project",
			"samples/web/Sample/Tizen/Web\ App/EventManager/project",
			"samples/web/Sample/Tizen/Web\ App/ExercisePlanner/project",
			"samples/web/Sample/Tizen/Web\ App/FileManager/project",
			"samples/web/Sample/Tizen/Web\ App/ImageRotation/project",
			"samples/web/Sample/Tizen/Web\ App/MediaContent/project",
			"samples/web/Sample/Tizen/Web\ App/NPRuntime/project",
			"samples/web/Sample/Tizen/Web\ App/OfflineClockImage/project",
			"samples/web/Sample/Tizen/Web\ App/Piano/project",
			"samples/web/Sample/Tizen/Web\ App/SelfCamera/project",
			"samples/web/Sample/Tizen/Web\ App/SensorBall/project",
			"samples/web/Sample/Tizen/Web\ App/SystemInfo/project",
			"samples/web/Sample/Tizen/Web\ App/TaskManager/project",
			"samples/web/Sample/Tizen/Web\ App/TizenWinset/project",
			"samples/web/Sample/Tizen/Web\ App/TouchPaint/project",
			"samples/web/Sample/Tizen/Hybrid\ Application/HybridWebApp/project",
		]),
