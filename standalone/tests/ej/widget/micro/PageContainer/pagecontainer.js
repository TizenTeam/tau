module("ej.widget.micro.PageContainer", {});

var element = document.getElementById('qunit-fixture');
element.addEventListener('widgetbuilt', function() {
	test("ej.widget.micro.PageContainer showLoading/hideLoading method", function () {
		var element = document.getElementById('qunit-fixture'),
	...
	asyncTest("ej.widget.micro.PageContainer change page", function () {
		expect(1);
		var element = document.getElementById('qunit-fixture'),
	...
	if (!window.navigator.userAgent.match('PhantomJS')) {
		asyncTest("ej.widget.micro.PageContainer change page with transition", function () {
			expect(1);
			var element = document.getElementById('qunit-fixture'),
		...
		asyncTest("ej.widget.micro.PageContainer change page with transition reverse", function () {
			expect(1);
			var element = document.getElementById('qunit-fixture'),
