	...
	define(
		...
		function () {
			...
			var Datetimepicker = function() {
				...
				BaseWidget = ej.widget.BaseWidget,
				engine = ej.engine,
				pickerPrototype,
			...
			pickerPrototype._build = function (template, element) {
				var self = this,
					currentDate,
					input,
					inputValue,
			...
			/**
			 * @method setTime
			 * @param {Date|string|number} yearOrDate When hourOfDate is an Date instance other parameters are ignored
			...
			// definition
			ej.widget.micro.Datetimepicker = Datetimepicker;
			engine.defineWidget(
				"datetimepicker",
				"",
