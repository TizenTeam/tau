/*
* jQuery Mobile Framework : "Extendable List" plugin
...
$.widget( "mobile.extendablelist", $.mobile.widget, {
	options: {
		theme: "s",
		countTheme: "c",
		headerTheme: "b",
...
$( document ).bind( "pagecreate create", function( e ){
	$( $.mobile.extendablelist.prototype.options.initSelector, e.target ).extendablelist();
});
